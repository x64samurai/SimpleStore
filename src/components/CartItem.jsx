...
import { addQuantity, removeQuantity } from "../redux/products";
            ...
            <div className="rounded-lg">
                <div className="justify-between mb-6 rounded-lg bg-white p-6 shadow-md sm:flex sm:justify-start">
                    <img
                        src={imgUrl}
                        alt="product-image"
                        className="w-full h-68 rounded-lg sm:w-40"
                    />
                    <div className="sm:ml-4 sm:flex sm:w-full sm:justify-between">
                        ...
                        <div className="mt-5 sm:mt-0">
                            ...
                            <p className="mt-1 text-sm text-gray-700">Стоимость: {price} руб</p>
                            <p className="mt-1 text-sm text-gray-700">Тип продукта: {category}</p>
                        </div>
